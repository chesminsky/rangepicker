(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('moment'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@sgv/rangepicker', ['exports', 'moment', '@angular/common', '@angular/core'], factory) :
    (factory((global.sgv = global.sgv || {}, global.sgv.rangepicker = {}),global.moment_,global.ng.common,global.ng.core));
}(this, (function (exports,moment_,common,core) { 'use strict';
     ...
     */
    /** @type {?} */
    var SgvRangepickerDefaultsService = new core.InjectionToken('SgvRangepickerDefaults');
    ...
    var presets = [{
        ...
        {
            start: moment$2().subtract(15, 'm'),
            end: moment$2(),
            code: 'LAST_15_MIN'
        },
        {
            start: moment$2().subtract(30, 'm'),
            end: moment$2(),
            code: 'LAST_30_MIN'
        },
        {
            start: moment$2().subtract(1, 'h'),
            end: moment$2(),
            code: 'LAST_HOUR'
        },
        {
            start: moment$2().subtract(4, 'h'),
            end: moment$2(),
            code: 'LAST_4_HOURS'
        },
        {
            start: moment$2().subtract(12, 'h'),
            end: moment$2(),
            code: 'LAST_12_HOURS'
        },
        {
            start: moment$2().subtract(1, 'd'),
            end: moment$2(),
            code: 'LAST_24_HOURS'
        },
        {
