 ...
 */
/** @type {?} */
var SgvRangepickerDefaultsService = new InjectionToken('SgvRangepickerDefaults');
...
var SgvRangepickerDirective = /** @class */ (function () {
    ...
    function () {
        ...
        function (period) {
            ...
            _this.elemRef.nativeElement.value = moment$2(start).format(_this.defaults.format) + ' - ' + moment$2(end).format(_this.defaults.format);
        }));
