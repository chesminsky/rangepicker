 ...
 */
/** @type {?} */
const SgvRangepickerOptions = new InjectionToken('options');

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class SgvRangepickerDefaultsService {
    /**
     * @param {?} options
     */
    constructor(options) {
...
class SgvRangepickerDirective {
    ...
    ngAfterViewInit() {
        ...
        (period) => {
            ...
            this.writeValue(moment$2(start).format(this.defaults.format) + ' - ' + moment$2(end).format(this.defaults.format));
            this.onChange();
        }));
