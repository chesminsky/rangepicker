...
import { InjectionToken, Injectable, Optional, Inject, Component, HostListener, Output, EventEmitter, Directive, Input, ElementRef, LOCALE_ID, Pipe, NgModule } from '@angular/core';
 ...
 */
/** @type {?} */
var SgvRangepickerOptions = new InjectionToken('options');
        ...
        function (date) {
            ...
            if (counter === 1) {
                ...
                if (date.valueOf() < _this.period.start.valueOf()) {
                    _this.period.end = moment$1(_this.period.start).endOf('day').valueOf();
                    _this.period.start = date.valueOf();
                }
                else {
...
var SgvRangepickerDirective = /** @class */ (function () {
    ...
    function () {
        ...
        function (period) {
            ...
            _this.writeValue(moment$2(start).format(_this.defaults.format) + ' - ' + moment$2(end).format(_this.defaults.format));
            _this.onChange();
        }));
    ...
    function (value) {
        ...
        if (!value) {
            ...
            /** @type {?} */
            var start = moment$2(dates[0], this.defaults.format);
            /** @type {?} */
            var end = moment$2(dates[1], this.defaults.format);
...
export { SgvRangepickerModule, SgvRangepickerDirective, SgvCalendarComponent, SgvRangepickerComponent, SgvTranslatePipe, SgvRangepickerOptions, SgvRangepickerDefaultsService as ɵa };
